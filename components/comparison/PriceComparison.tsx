  ...
  return (
    <section aria-labelledby="price-comparison-heading" data-speakable="price-comparison">
      <div className="flex items-center gap-2.5 mb-4">
        ...
        <h2 id="price-comparison-heading" className="text-lg font-semibold text-gray-900">Price Comparison</h2>
      </div>
...
function PriceCard({ product, isLowest }: { product: Product; isLowest: boolean }) {
  ...
  return (
    <div className={`border rounded-xl p-5 text-center hover:shadow-sm motion-safe:hover:-translate-y-0.5 motion-safe:transition-all duration-200 ${isLowest ? "border-emerald-200 bg-emerald-50/40" : "border-gray-100 hover:border-gray-200"}`}>
      {isLowest && (
