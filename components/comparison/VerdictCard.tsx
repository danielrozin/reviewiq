        ...
        {winner && loser && (
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 mb-5">
            ...
            <Link
              ...
              className="flex-1 flex items-center gap-3 bg-white border-2 border-emerald-200 rounded-xl p-3.5 hover:border-emerald-300 hover:shadow-sm transition-all group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400 focus-visible:ring-offset-1"
            >
            ...
            <Link
              ...
              className="flex-1 flex items-center gap-3 bg-white border border-gray-500 rounded-xl p-3.5 hover:border-gray-600 hover:shadow-sm transition-all group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400 focus-visible:ring-offset-1"
            >
