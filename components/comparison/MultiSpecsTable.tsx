  ...
  return (
    <section aria-labelledby="specs-comparison-heading" data-speakable="specs-comparison">
      <div className="flex items-center justify-between mb-4 gap-3">
        ...
        {/* Mobile scroll hint */}
        <p className="text-xs text-gray-600 sm:hidden flex items-center gap-1">
      ...
      <div className="border border-gray-100 rounded-xl overflow-hidden">
        <div role="region" aria-label="Specs comparison — scrollable table" tabIndex={0} className="overflow-x-auto -webkit-overflow-scrolling-touch">
          <div style={{ minWidth: `${160 + products.length * 140}px` }} role="table" aria-label="Specs comparison">
            ...
            >
              <div role="columnheader" className="px-4 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider">
                Spec
              </div>
                  ...
                  return (
                    ...
                    >
                      <div role="rowheader" className="px-4 py-3 text-gray-600 flex items-center gap-2">
                        ...
                        {isDifferent && (
                          <span aria-label="values differ" className="text-xs font-semibold text-amber-800 bg-amber-100 px-1.5 py-0.5 rounded-lg leading-none shrink-0">
                            diff
                          </span>
                        )}
                      </div>
