      ...
      <div role="radiogroup" aria-label="Sort products by" className="flex items-center gap-2 mb-6 flex-wrap">
        ...
        {SORT_OPTIONS.map((opt, index) => (
          <button
            ...
            className={`px-3 py-1.5 rounded-xl text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:ring-offset-1 ${
              sortKey === opt.key
