    ...
    <div>
      ...
      <div className="relative mb-8 max-w-md">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2.5 border border-gray-400 rounded-xl text-sm text-gray-900 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-brand-600 focus:border-transparent bg-white"
        />
        {query && (
          <button
            type="button"
