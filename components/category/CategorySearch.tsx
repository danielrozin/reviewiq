    ...
    <div>
      ...
      <div role="search" className="relative mb-8 max-w-md">
        ...
        <input
          ...
          autoComplete="off"
          className="w-full pl-10 pr-4 py-2.5 border border-gray-500 rounded-xl text-sm text-gray-900 placeholder:text-gray-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:border-transparent bg-white"
        />
        {query && (
          <button
            type="button"
