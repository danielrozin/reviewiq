    ...
    <div>
      ...
      {filtered.length === 0 && (
        <div className="text-center py-16 px-6 bg-white border border-gray-100 rounded-2xl">
          ...
          <button onClick={() => setQuery("")} className="inline-flex items-center gap-1.5 text-xs font-medium text-brand-600 bg-brand-50 px-3 py-1.5 rounded-lg hover:bg-brand-100 transition-colors">
