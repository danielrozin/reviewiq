        ...
        {actions.map((action) => (
          <li key={action.title}>
            <Link
              ...
              className={`group flex flex-col bg-white border border-gray-100 rounded-xl overflow-hidden hover:-translate-y-0.5 transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:ring-offset-1 ${action.borderHover}`}
            >
