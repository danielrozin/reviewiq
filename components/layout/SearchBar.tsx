    ...
    <div ref={wrapperRef} className={`relative w-full ${className || (size === "lg" ? "max-w-xl" : "max-w-md")}`}>
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`w-full border border-gray-300 bg-gray-50 text-gray-900 placeholder-gray-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:border-transparent focus:bg-white transition-colors ${
            size === "lg"
        ...
        <div id="search-listbox" role="listbox" aria-label="Search suggestions" className="absolute top-full left-0 right-0 mt-2 bg-white border border-gray-200 rounded-xl shadow-lg overflow-hidden z-50">
          {results.map((result, i) => (
            ...
            >
              ...
              >
                {result.type === "category" ? (
                  <svg aria-hidden="true" className="w-4 h-4 text-gray-600" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
