    ...
    <div ref={wrapperRef} className={`relative w-full ${className || (size === "lg" ? "max-w-xl" : "max-w-md")}`}>
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`w-full border border-gray-500 bg-gray-50 text-gray-900 placeholder-gray-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:border-transparent focus:bg-white transition-colors ${
            size === "lg"
