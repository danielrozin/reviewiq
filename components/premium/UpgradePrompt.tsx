  ...
  if (compact) {
    return (
      <div className="flex items-center gap-3 p-3 bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 rounded-xl">
        ...
        <Link
          href="/pricing"
          className="shrink-0 inline-flex items-center gap-1 px-3 py-1.5 bg-amber-600 text-white text-xs font-medium rounded-xl hover:bg-amber-700 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-amber-600"
        >
  ...
  return (
    <div role="region" aria-labelledby={`upgrade-prompt-${gate}`} className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 border border-amber-200 p-6 text-center">
      ...
      <div className="relative">
        ...
        <ul aria-label="Pro features" className="flex items-center justify-center gap-4 mt-4 text-xs text-gray-600 list-none p-0 m-0">
