      ...
      {showMenu && isPro && (
        ...
        >
          <button
            ...
            className="w-full text-left px-3 py-2 min-h-[44px] flex items-center text-sm text-gray-700 hover:bg-gray-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:ring-inset"
          >
            Export as CSV
          </button>
          <button
