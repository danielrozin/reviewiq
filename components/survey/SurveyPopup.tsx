                ...
                <button
                  ...
                  className={`w-full text-left px-4 py-3 text-sm rounded-xl border transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:ring-offset-1 ${
                    answers.q1Intent === opt.value
                      ...
                      : "border-gray-200 hover:border-gray-200 hover:bg-gray-50 text-gray-700"
                  }`}
                >
                  {opt.label}
                </button>
          ...
          <div>
            ...
            <div ref={q2GroupRef} role="radiogroup" aria-label="Did you find what you were looking for?" className="flex gap-3 mb-4" onKeyDown={handleQ2KeyDown}>
              <button
                ...
                className="flex-1 px-4 py-3 text-sm font-medium rounded-xl border border-gray-200 hover:border-emerald-400 hover:bg-emerald-50 text-gray-700 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:ring-offset-1"
              >
                Yes
              </button>
              <button
            ...
            {answers.q2Found === false && (
              <>
                <textarea
                  ...
                  className="w-full px-3 py-2 text-sm border border-gray-200 rounded-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:ring-offset-1 resize-none"
                  rows={2}
                />
                <button
                  type="button"
