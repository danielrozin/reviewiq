            ...
            {answers.q2Found === false && (
              <>
                <textarea
                  ...
                  className="w-full px-3 py-2 text-sm border border-gray-400 rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-600/20 focus:border-brand-600 resize-none"
                  rows={2}
                />
                <button
                  type="button"
