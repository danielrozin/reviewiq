...
export function WriteReviewCTA({ productName, productSlug }: WriteReviewCTAProps) {
  return (
    <section className="bg-gradient-to-br from-brand-50 via-white to-brand-50 border border-brand-100 rounded-2xl p-6 sm:p-8 text-center">
      ...
      <div className="flex items-center justify-center gap-0.5 mb-3">
        ...
        <span className="text-xs text-gray-500 ml-1.5">Trusted by thousands of buyers</span>
      </div>

      <div className="w-7 h-7 bg-brand-100 rounded-lg flex items-center justify-center mx-auto mb-3">
      ...
      <p className="text-xs text-gray-400 mt-3">Free · No account required</p>
    </section>
  );
}
