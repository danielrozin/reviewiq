  ...
  return (
    <div className="bg-gradient-to-r from-brand-50/60 to-white border border-brand-100 rounded-xl p-4 flex items-center justify-between gap-4">
      ...
      <Link
        ...
        className="shrink-0 inline-flex items-center gap-1.5 px-4 py-2 text-sm font-semibold text-white bg-brand-600 hover:bg-brand-700 rounded-xl transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-brand-600"
      >
