    ...
    <section id="section-reviews" aria-labelledby="verified-reviews-heading" className="scroll-mt-28">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-6">
        ...
        <select
          ...
          className="text-sm text-gray-600 bg-white border border-gray-300 rounded-xl px-3 py-3 min-h-[44px] focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:border-transparent cursor-pointer"
      ...
      {shown.length === 0 ? (
        <div className="text-center py-10 px-6 bg-white border border-gray-100 rounded-2xl">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 text-xs font-medium text-brand-600 bg-brand-50 px-3 py-1.5 min-h-[44px] rounded-xl hover:bg-brand-100 transition-colors touch-manipulation focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:ring-offset-1"
          >
