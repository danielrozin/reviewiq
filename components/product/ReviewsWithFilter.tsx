    ...
    <section id="section-reviews" aria-labelledby="verified-reviews-heading">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-6">
        ...
        <select
          ...
          className="text-sm text-gray-600 bg-white border border-gray-500 rounded-xl px-3 py-3 min-h-[44px] focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:border-transparent cursor-pointer"
