    ...
    <article aria-labelledby={`review-${review.id}-headline`} className="bg-white border border-gray-100 rounded-xl hover:border-gray-200 hover:shadow-sm hover:-translate-y-0.5 transition-all duration-200 overflow-hidden group">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 pt-3 border-t border-gray-50">
        <div className="flex flex-wrap gap-1.5">
          <span role="img" aria-label={`Reliability: ${review.reliabilityRating} out of 5`} className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-brand-50 text-brand-700 text-xs font-medium">
          ...
          <span role="img" aria-label={`Ease of use: ${review.easeOfUseRating} out of 5`} className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-emerald-50 text-emerald-700 text-xs font-medium">
            <svg aria-hidden="true" className="w-3 h-3 shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="m3.75 13.5 10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75Z" />
            </svg>
            <span aria-hidden="true">Ease {review.easeOfUseRating}/5</span>
          </span>
          <span role="img" aria-label={`Value: ${review.valueRating} out of 5`} className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-amber-50 text-amber-700 text-xs font-medium">
            <svg aria-hidden="true" className="w-3 h-3 shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
