...
export function ReviewCard({ review }: ReviewCardProps) {
  return (
    <article aria-labelledby={`review-${review.id}-headline`} className="bg-white border border-gray-100 rounded-xl hover:border-gray-200 hover:shadow-sm motion-safe:hover:-translate-y-0.5 motion-safe:transition-all duration-200 overflow-hidden group">
