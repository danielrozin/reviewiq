    ...
    >
      ...
      <div className="lg:hidden px-3 py-2.5">
        <div className="flex items-center gap-2">
          ...
          <Link
            href={compareHref}
            className="shrink-0 inline-flex items-center gap-1 min-h-[44px] px-3 py-3 text-xs font-medium text-gray-700 bg-white border border-gray-500 rounded-xl hover:bg-gray-50 transition-colors touch-manipulation focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400 focus-visible:ring-offset-1"
