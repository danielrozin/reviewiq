  ...
  return (
    <section aria-labelledby="ai-review-summary" data-speakable="ai-summary" className="bg-gradient-to-br from-brand-50/50 to-white border border-brand-100/60 rounded-2xl p-6 lg:p-8">
      <div className="flex items-center gap-2 mb-4">
        ...
        <div>
          <h2 id="ai-review-summary" className="text-lg font-semibold text-gray-900">
            AI Review Summary
          </h2>
      ...
      {/* TL;DR Verdict */}
      {verdict && (
        <div role="note" aria-label={verdict.label} data-speakable="verdict" className={`flex items-center gap-3 px-4 py-3 rounded-xl border mb-6 ${verdict.bg} ${verdict.border}`}>
