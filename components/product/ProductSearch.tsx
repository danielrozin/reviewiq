    ...
    <div className="space-y-6">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-12 pr-4 py-3 text-base border border-gray-400 rounded-xl bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:border-transparent transition-colors"
        />
        {query && (
          <button
            type="button"
      ...
      <div role="group" aria-label="Filter products" className="flex flex-wrap items-center gap-3">
        ...
        <select
          ...
          className="px-3 py-2 text-sm border border-gray-400 rounded-xl bg-white text-gray-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-600"
        >
        ...
        <div role="group" aria-label="Price range" className="flex items-center gap-2 text-sm text-gray-600">
          ...
          <input
            ...
            className="w-20 px-2 py-2 border border-gray-400 rounded-xl bg-white text-gray-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 text-sm"
