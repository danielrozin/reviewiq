    ...
    <div className="space-y-6">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-12 pr-4 py-3 text-base border border-gray-200 rounded-xl bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-brand-600 focus:border-transparent transition-colors"
        />
        {query && (
          <button
            type="button"
      ...
      <div role="group" aria-label="Filter products" className="flex flex-wrap items-center gap-3">
        ...
        <div role="group" aria-label="Price range" className="flex items-center gap-2 text-sm text-gray-600">
          ...
          <input
            ...
            className="w-20 px-2 py-2 border border-gray-200 rounded-xl bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-brand-600 text-sm"
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {query && (
            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-brand-50 text-brand-700 text-xs font-medium rounded-full border border-brand-100">
              ...
              &ldquo;{query}&rdquo;
              <button type="button" onClick={() => setFilter("q", "")} className="ml-0.5 p-1 hover:text-brand-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400 rounded" aria-label="Remove search filter">
          ...
          {category && (
            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-purple-50 text-purple-700 text-xs font-medium rounded-full border border-purple-100">
              ...
              <button type="button" onClick={() => setFilter("category", "")} className="ml-0.5 p-1 hover:text-purple-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400 rounded" aria-label="Remove category filter">
                <svg aria-hidden="true" className="w-3 h-3" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M6 18 18 6M6 6l12 12" />
                </svg>
              </button>
          ...
          {minRating > 0 && (
            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-amber-50 text-amber-700 text-xs font-medium rounded-full border border-amber-100">
              ...
              {minRating}+ stars
              <button type="button" onClick={() => setFilter("rating", 0)} className="ml-0.5 p-1 hover:text-amber-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400 rounded" aria-label="Remove rating filter">
                <svg aria-hidden="true" className="w-3 h-3" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M6 18 18 6M6 6l12 12" />
                </svg>
              </button>
          ...
          {(priceMin > GLOBAL_MIN_PRICE || priceMax < GLOBAL_MAX_PRICE) && (
            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-emerald-50 text-emerald-700 text-xs font-medium rounded-full border border-emerald-100">
              ...
              <button
                ...
                className="ml-0.5 p-1 hover:text-emerald-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400 rounded"
