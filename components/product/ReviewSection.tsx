        ...
        <div className="relative">
          <div className="flex items-center gap-1.5">
            ...
            <select
              ...
              className="text-sm text-gray-600 bg-transparent border border-gray-400 rounded-xl px-3 py-2.5 pr-8 min-h-[44px] appearance-none cursor-pointer hover:border-gray-500 focus:outline-none focus:ring-2 focus:ring-brand-600/20 focus:border-brand-600"
            >
