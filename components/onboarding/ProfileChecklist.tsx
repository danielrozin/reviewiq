...
export function ProfileChecklist() {
  ...
  return (
    <div className="bg-white border border-gray-100 rounded-2xl p-5 sm:p-6">
      ...
      <ul role="list" aria-label="Profile completion checklist" className="space-y-1.5">
        {CHECKLIST_ITEMS.map((item) => {
          ...
          const inner = (
            <>
              ...
              {!done && (
                <svg aria-hidden="true" className="w-4 h-4 text-gray-400 shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor">
