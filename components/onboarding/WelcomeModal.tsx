    ...
    <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-4">
      ...
      >
        <button
          ...
          className="absolute top-3 right-3 p-1.5 text-gray-500 hover:text-gray-700 rounded-lg hover:bg-gray-100 transition-colors z-10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:ring-offset-1"
