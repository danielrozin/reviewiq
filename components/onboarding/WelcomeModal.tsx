    ...
    <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-4">
      ...
      >
        <button
          ...
          className="absolute top-3 right-3 p-1.5 min-h-[44px] min-w-[44px] flex items-center justify-center touch-manipulation text-gray-500 hover:text-gray-700 rounded-lg hover:bg-gray-100 transition-colors z-10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:ring-offset-1"
            ...
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <button
                  type="button"
                  onClick={dismissWelcome}
                  className="px-6 py-3 text-sm font-medium text-gray-600 bg-gray-100 rounded-xl hover:bg-gray-200 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:ring-offset-1"
                >
