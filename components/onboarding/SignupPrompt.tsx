...
const BENEFITS: { icon: React.ReactElement; text: string }[] = [
  {
    icon: (
      <svg aria-hidden="true" className="w-4 h-4 text-brand-600" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      >
        ...
        <div className="text-center mb-5">
          <div aria-hidden="true" className="w-12 h-12 bg-brand-50 rounded-xl flex items-center justify-center mx-auto mb-4">
            <svg aria-hidden="true" className="w-6 h-6 text-brand-600" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
