    ...
    <div className="space-y-3">
      ...
      <div ref={sortGroupRef} role="radiogroup" aria-label="Sort discussions by" className="flex items-center gap-1 overflow-x-auto pb-1" onKeyDown={handleSortKeyDown}>
        {SORT_OPTIONS.map((option) => (
          <button
            ...
            className={`text-xs font-medium px-3 py-1.5 min-h-[44px] rounded-xl whitespace-nowrap transition-colors border touch-manipulation focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:ring-offset-1 ${
              sort === option.value
      ...
      <div ref={typeGroupRef} role="radiogroup" aria-label="Filter by thread type" className="flex items-center gap-1.5 overflow-x-auto pb-1" onKeyDown={handleTypeKeyDown}>
        <button
          ...
          className={`text-xs font-medium px-2.5 py-1 min-h-[44px] rounded-full border whitespace-nowrap transition-colors touch-manipulation focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:ring-offset-1 ${
            typeFilter === null
