  ...
  return (
    <li className={`${isNested ? "ml-6 pl-4 border-l-2 border-gray-100" : ""}`}>
      <article
        ...
        className={`group py-4 px-1 rounded-xl transition-colors hover:bg-gray-50/60 ${depth === 0 ? "border-b border-gray-100" : ""}`}
      >
        {/* Comment header */}
        <div className="flex items-center gap-2 mb-2">
          ...
          <time dateTime={comment.createdAt} className="text-xs text-gray-600 ml-auto">
...
export function CommentThread({ comments }: CommentThreadProps) {
  ...
  return (
    <ul role="list" aria-label="Comments" className="divide-y divide-gray-100">
      {sorted.map((comment) => (
