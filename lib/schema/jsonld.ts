...
export function communityPageSchema(threads?: DiscussionThread[], datePublished?: string, dateModified?: string) {
  ...
  return {
    ...
    abstract: "A discussion forum where verified ReviewIQ users ask product questions, share ownership experiences, and help each other make smarter buying decisions.",
    url: pageUrl,
    inLanguage: "en-US",
    isAccessibleForFree: true,
    accessMode: ["textual"],
...
export function homePageSchema(featuredPosts?: BlogPost[]) {
  return {
    ...
    abstract: "ReviewIQ aggregates verified buyer reviews and applies AI analysis to generate honest, structured product intelligence — SmartScores, pros and cons, and side-by-side comparisons — with zero affiliate bias.",
    url: SITE_URL,
    inLanguage: "en-US",
    isAccessibleForFree: true,
    copyrightHolder: { "@id": `${SITE_URL}/#organization` },
...
export function speakableSchema(productName: string, productUrl: string, datePublished?: string, dateModified?: string) {
  ...
  return {
    ...
    abstract: `AI-powered review of ${productName} — SmartScore, verified buyer analysis, pros and cons, reliability data, and side-by-side comparisons from ReviewIQ.`,
    url: pageUrl,
    inLanguage: "en-US",
    isAccessibleForFree: true,
    ...(datePublished && { datePublished }),
...
export function blogPostSpeakableSchema(title: string, url: string, datePublished?: string, dateModified?: string) {
  ...
  return {
    ...
    "@id": `${pageUrl}#page`,
    name: title,
    abstract: `${title} — a ReviewIQ buying guide with expert analysis, verified buyer data, and product comparisons.`,
    url: pageUrl,
    inLanguage: "en-US",
    isAccessibleForFree: true,
    ...(datePublished && { datePublished }),
...
export function threadPageSpeakableSchema(title: string, url: string, datePublished?: string, dateModified?: string) {
  ...
  return {
    ...
    "@id": `${pageUrl}#page`,
    name: title,
    abstract: `Community discussion: ${title} — real buyer questions and answers on ReviewIQ.`,
    url: pageUrl,
    inLanguage: "en-US",
    isAccessibleForFree: true,
    ...(datePublished && { datePublished }),
