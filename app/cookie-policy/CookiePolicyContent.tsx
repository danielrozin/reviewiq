    ...
    >
      <section aria-label="Cookie Policy introduction">
        <p data-speakable="cookie-policy-intro">
          ...
          <Link href="/privacy" className="text-brand-600 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:ring-offset-1 rounded">Privacy Policy</Link>.
        </p>
      </section>
