        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <section aria-labelledby="dashboard-reviews-heading">
            <div className="flex items-center justify-between mb-4">
              ...
              >
                Write a review
                <svg aria-hidden="true" className="w-3 h-3 motion-safe:group-hover:translate-x-0.5 motion-safe:transition-transform" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                </svg>
              </Link>
            </div>
