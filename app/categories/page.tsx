  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <header className="mt-8 mb-10 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        ...
        {/* Quick stat pills */}
        <ul role="list" className="flex items-center gap-3 shrink-0 list-none p-0 m-0" aria-label="Platform statistics">
          <li className="flex items-center gap-1.5 px-3 py-1.5 bg-emerald-50 text-emerald-700 rounded-full text-xs font-medium">
          ...
          <li className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 bg-brand-50 text-brand-700 rounded-full text-xs font-medium">
