  ...
  return (
    ...
    >
      ...
      <section id="acceptance" aria-labelledby="acceptance-h">
        <h2 id="acceptance-h" className="text-2xl font-bold text-gray-900 mb-4">1. Acceptance of Terms</h2>
        <p>
      ...
      <section id="use-of-site" aria-labelledby="use-of-site-h">
        <h2 id="use-of-site-h" className="text-2xl font-bold text-gray-900 mb-4">2. Use of the Site</h2>
      ...
      <section id="user-content" aria-labelledby="user-content-h">
        <h2 id="user-content-h" className="text-2xl font-bold text-gray-900 mb-4">3. User Content and Reviews</h2>
        <p className="mb-4">
      ...
      <section id="intellectual-property" aria-labelledby="intellectual-property-h">
        <h2 id="intellectual-property-h" className="text-2xl font-bold text-gray-900 mb-4">4. Intellectual Property</h2>
        <p>
      ...
      <section id="disclaimers" aria-labelledby="disclaimers-h">
        <h2 id="disclaimers-h" className="text-2xl font-bold text-gray-900 mb-4">5. Disclaimers</h2>
        <p>
      ...
      <section id="limitation-of-liability" aria-labelledby="limitation-of-liability-h">
        <h2 id="limitation-of-liability-h" className="text-2xl font-bold text-gray-900 mb-4">6. Limitation of Liability</h2>
        <p>
      ...
      <section id="termination" aria-labelledby="termination-h">
        <h2 id="termination-h" className="text-2xl font-bold text-gray-900 mb-4">7. Termination</h2>
        <p>We may terminate or restrict your access at any time for violation of these Terms.</p>
      </section>

      <section id="governing-law" aria-labelledby="governing-law-h">
        <h2 id="governing-law-h" className="text-2xl font-bold text-gray-900 mb-4">8. Governing Law</h2>
        <p>These Terms shall be governed by applicable laws. Disputes shall first be resolved through good-faith negotiation.</p>
      </section>

      <section id="changes" aria-labelledby="terms-changes-h">
        <h2 id="terms-changes-h" className="text-2xl font-bold text-gray-900 mb-4">9. Changes to These Terms</h2>
        <p>We may update these Terms at any time. Continued use constitutes acceptance.</p>
      </section>

      <section id="contact" aria-labelledby="terms-contact-h">
        <h2 id="terms-contact-h" className="text-2xl font-bold text-gray-900 mb-4">10. Contact</h2>
