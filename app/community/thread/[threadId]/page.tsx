              ...
              <div className="flex-1 min-w-0">
                ...
                {thread.productSlug && thread.categorySlug && (
                  <Link
                    ...
                    className="group flex items-center gap-3 bg-white border border-gray-100 rounded-xl p-4 mb-6 hover:border-brand-200 hover:shadow-sm transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400 focus-visible:ring-offset-1"
                  >
                ...
                <div className="flex items-center gap-4 py-4 border-t border-b border-gray-100 mb-8">
                  <button type="button" aria-label="Share this thread" className="inline-flex items-center gap-1.5 min-h-[44px] px-3 text-sm text-gray-600 hover:text-gray-700 transition-colors font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400 focus-visible:ring-offset-1 rounded">
                  ...
                  <button type="button" aria-label="Save this thread" className="inline-flex items-center gap-1.5 min-h-[44px] px-3 text-sm text-gray-600 hover:text-gray-700 transition-colors font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400 focus-visible:ring-offset-1 rounded">
                    <svg aria-hidden="true" className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M17.593 3.322c1.1.128 1.907 1.077 1.907 2.185V21L12 17.25 4.5 21V5.507c0-1.108.806-2.057 1.907-2.185a48.507 48.507 0 0 1 11.186 0Z" />
                    </svg>
                    Save
                  </button>
                  <button type="button" aria-label="Report this thread" className="inline-flex items-center gap-1.5 min-h-[44px] px-3 text-sm text-gray-600 hover:text-gray-700 transition-colors font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400 focus-visible:ring-offset-1 rounded">
                    <svg aria-hidden="true" className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
                  ...
                  <button type="button" aria-label="Follow this thread" className="inline-flex items-center gap-1.5 min-h-[44px] px-3 text-sm text-gray-600 hover:text-gray-700 transition-colors font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400 focus-visible:ring-offset-1 rounded">
                    <svg aria-hidden="true" className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
          ...
          <section aria-labelledby="thread-replies-heading">
            ...
            <div className="border border-gray-400 rounded-xl p-4 mb-6">
              ...
              <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                ...
                <button type="button" className="inline-flex items-center gap-1.5 px-4 py-2.5 min-h-[44px] bg-brand-600 text-white text-sm font-medium rounded-xl hover:bg-brand-700 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-brand-600">
                  <svg aria-hidden="true" className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
