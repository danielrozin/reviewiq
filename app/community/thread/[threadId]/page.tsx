  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(threadPageSpeakableSchema(thread.title, `/community/thread/${threadId}`)),
        }}
      />
      <Breadcrumbs
        items={[
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-4 py-4 border-t border-b border-gray-100 mb-8">
                  <button type="button" className="inline-flex items-center gap-1.5 min-h-[44px] px-3 text-sm text-gray-600 hover:text-gray-700 transition-colors font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400 focus-visible:ring-offset-1 rounded">
