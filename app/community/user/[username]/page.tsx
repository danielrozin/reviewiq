      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 mt-8">
        ...
        <aside aria-label="User profile">
          <div className="bg-white border border-gray-100 rounded-2xl p-6 sticky top-24">
            ...
            {/* Stats grid */}
            <dl aria-label="User statistics" className="grid grid-cols-2 gap-2 mb-6">
              {[
          ...
          <section aria-labelledby="user-discussions-heading">
            ...
            {userThreads.length > 0 ? (
              ...
              <div className="text-center py-10 px-6 bg-white border border-gray-100 rounded-2xl">
                ...
                <p className="text-xs text-gray-600">Discussions this user starts will appear here.</p>
              </div>
            )}
          </section>
          ...
          <section aria-labelledby="user-comments-heading">
            ...
            {userComments.length > 0 ? (
                ...
                {userComments.slice(0, 5).map((comment) => (
                  ...
                  >
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <time dateTime={comment.createdAt} className="text-xs text-gray-600">{new Intl.DateTimeFormat("en-US", { year: "numeric", month: "short", day: "numeric", timeZone: "UTC" }).format(new Date(comment.createdAt))}</time>
                      {comment.isTopAnswer && (
              ...
              <div className="text-center py-10 px-6 bg-white border border-gray-100 rounded-2xl">
                ...
                <p className="text-xs text-gray-600">Comments this user leaves on threads will appear here.</p>
              </div>
            )}
          </section>
        </div>
