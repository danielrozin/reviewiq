      ...
      <header className="mt-6 mb-10" data-speakable="community-hero">
        ...
        <dl className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            ...
            <div key={stat.label} className="bg-white border border-gray-100 rounded-xl p-4 flex items-center gap-3 hover:shadow-sm hover:border-gray-200 motion-safe:hover:-translate-y-0.5 motion-safe:transition-all duration-200">
