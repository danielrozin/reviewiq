      ...
      <header className="mt-6 mb-10" data-speakable="community-hero">
        <div className="relative overflow-hidden bg-gradient-to-br from-brand-600 via-brand-500 to-brand-400 rounded-2xl px-6 sm:px-10 py-8 sm:py-10 text-white mb-6">
          ...
          <div className="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-5">
            ...
            <Link
              href="/community/new"
              className="inline-flex items-center gap-2 self-start sm:self-auto px-5 py-3 min-h-[44px] bg-white text-brand-600 text-sm font-semibold rounded-xl hover:bg-brand-50 transition-colors shadow-sm shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:ring-offset-1"
            >
        ...
        {/* Stats bar */}
        <ul role="list" className="grid grid-cols-2 sm:grid-cols-4 gap-3 list-none p-0 m-0">
          {[
            ...
            <li key={stat.label} className="bg-white border border-gray-100 rounded-xl p-4 flex items-center gap-3 hover:shadow-sm hover:border-gray-200 hover:-translate-y-0.5 transition-all duration-200">
              ...
              {categories.map((cat) => {
                ...
                return (
                  ...
                  <Link
                    ...
                    className="flex items-center justify-between py-2 px-3 rounded-xl hover:bg-gray-50 transition-colors group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:ring-offset-1"
                  >
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <svg aria-hidden="true" className="w-3 h-3 text-gray-400 group-hover:text-brand-400 transition-colors" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor">
