    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      <div className="text-center mb-12">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-16">
          <Link
            href="/"
            className="w-full sm:w-auto px-6 py-3 bg-brand-600 text-white font-semibold rounded-xl hover:bg-brand-700 active:scale-[0.98] transition-all shadow-sm text-center"
          >
            Back to Home
          </Link>
          <Link
            href="/categories"
            className="w-full sm:w-auto px-6 py-3 bg-white text-gray-700 font-semibold rounded-xl hover:bg-gray-50 border border-gray-200 active:scale-[0.98] transition-all text-center"
          >
            Browse Categories
          </Link>
        </div>
      ...
      {/* Popular categories */}
      <div>
        <h2 className="text-sm font-semibold text-gray-400 uppercase tracking-wider text-center mb-5">
          Popular categories
        </h2>
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          {popularCategories.map((cat) => (
            <Link
              ...
              className="flex items-center gap-3 p-4 bg-white border border-gray-100 rounded-xl hover:border-brand-200 hover:shadow-sm hover:-translate-y-0.5 transition-all group"
            >
