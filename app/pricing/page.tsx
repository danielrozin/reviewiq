      ...
      <section aria-label="Customer proof" className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 -mt-4 mb-8">
        ...
        <ul role="list" className="grid sm:grid-cols-3 gap-4 mt-4 list-none p-0 m-0">
          {[
            ...
            <li key={t.name} className="bg-white border border-gray-100 rounded-xl overflow-hidden shadow-sm hover:shadow-md motion-safe:hover:-translate-y-0.5 motion-safe:transition-all duration-200 group">
