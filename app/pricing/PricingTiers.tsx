...
export function PricingTiers() {
  ...
  return (
    <ul role="list" aria-label="Pricing plans" className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
      {/* Free Plan */}
      <li><article aria-labelledby="plan-free-name" className="bg-white rounded-2xl border border-gray-200 overflow-hidden flex flex-col hover:shadow-sm hover:border-gray-300 motion-safe:hover:-translate-y-0.5 transition-all duration-200 group">
      ...
      {/* Pro Plan */}
      <li><article aria-labelledby="plan-pro-name" className="bg-white rounded-2xl border-2 border-brand-500 p-8 flex flex-col relative shadow-lg shadow-brand-100/50 hover:shadow-xl motion-safe:hover:-translate-y-1 transition-all duration-200">
