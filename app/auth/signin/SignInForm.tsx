    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      ...
      <div className="w-full max-w-4xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <aside aria-label="Why join ReviewIQ" className="hidden lg:block">
          <Link href="/" className="inline-flex items-center gap-2.5 mb-8 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:ring-offset-1 rounded-lg">
        ...
        <div className="w-full max-w-sm mx-auto lg:mx-0">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm space-y-4">
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 px-4 py-3 min-h-[44px] border border-gray-200 rounded-xl text-sm font-semibold text-gray-700 hover:bg-gray-50 transition-colors touch-manipulation disabled:opacity-50 shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:ring-offset-1"
            >
