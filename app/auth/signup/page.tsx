...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  Callback: "Sign-up failed. Please try again.",
  ...
  default: "Something went wrong with sign-up. Please try again.",
};
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm space-y-4">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-4 py-3.5 border border-gray-400 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400 focus-visible:ring-offset-1"
          >
