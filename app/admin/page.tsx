  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl p-4 flex items-start gap-3">
      ...
      <dl>
        ...
        <dd className="text-2xl font-bold text-gray-900 mt-0.5">{value}</dd>
      </dl>
    </div>
  );
}
  ...
  if (checking) {
    return (
      <div role="status" aria-label="Loading admin panel" className="min-h-screen flex items-center justify-center bg-gray-50">
        <RefreshCw aria-hidden="true" className="w-6 h-6 text-gray-400 motion-safe:animate-spin" />
      </div>
    );
  }
          ...
          <div className="space-y-4">
            <div className="flex flex-wrap items-center gap-4">
              ...
              <select
                ...
                className="px-3 py-2 border border-gray-400 rounded-lg text-sm text-gray-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-600"
              >
                    ...
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        ...
                        <button
                          ...
                          className="flex items-center gap-1.5 px-3 py-1.5 border border-yellow-300 text-yellow-700 text-xs rounded-lg hover:bg-yellow-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:ring-offset-1"
                        >
                        ...
                        <button
                          ...
                          onClick={() => handleQueueAction(r.id, "rejected")}
                          aria-label={`Reject review: ${r.headline}`}
                          className="flex items-center gap-1.5 px-3 py-1.5 border border-red-300 text-red-700 text-xs rounded-lg hover:bg-red-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:ring-offset-1"
                        >
          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 rounded-2xl p-6">
              ...
              <p className="text-sm text-gray-600 mt-1">
                Key metrics and trends across ReviewIQ content.
              </p>
            </div>
