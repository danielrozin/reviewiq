        ...
        <div className="lg:flex lg:items-start lg:gap-10">
          ...
          {product.image && (
            <div className="lg:w-60 xl:w-72 shrink-0 mb-8 lg:mb-0">
              ...
              <div className="mt-3 flex items-center justify-center gap-2 px-3 py-2 bg-white border border-gray-100 rounded-xl shadow-sm hover:shadow-md motion-safe:transition-all duration-200">
