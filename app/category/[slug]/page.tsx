            ...
            {buyingGuide.steps.map((step, index) => (
              <li key={index} className="flex gap-5 group pb-6 last:pb-0">
                ...
                <div className="flex-1 pb-1">
                  <div className="bg-white border border-gray-100 rounded-xl p-4 group-hover:border-brand-200 group-hover:shadow-sm motion-safe:group-hover:-translate-y-0.5 motion-safe:transition-all duration-200">
