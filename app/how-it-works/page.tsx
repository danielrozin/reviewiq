...
export default function HowItWorksPage() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbSchema([{ name: "How It Works", url: "/how-it-works" }])) }} />
      ...
      <section aria-label="How ReviewIQ works — step by step" className="relative max-w-4xl" data-speakable="how-it-works-steps">
        ...
        <ol role="list" className="list-none space-y-12">
                    ...
                    {row.us === true ? (
                      ...
                      <>
                        <span aria-hidden="true" className="inline-flex items-center justify-center w-6 h-6 bg-gray-100 rounded-full">
                          <svg aria-hidden="true" className="w-3.5 h-3.5 text-gray-500" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M6 18 18 6M6 6l12 12" /></svg>
                        </span>
