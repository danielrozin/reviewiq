          ...
          {personas.map((persona, pi) => (
            ...
            <article aria-labelledby={`persona-heading-${pi}`} className="bg-white border border-gray-100 rounded-2xl overflow-hidden hover:shadow-md motion-safe:hover:-translate-y-0.5 motion-safe:transition-all duration-200 group">
              ...
              <div className="flex-1 min-w-0">
                <h3 id={`persona-heading-${pi}`} className="text-lg font-bold text-gray-900 mb-3">
                  {persona.title}
                </h3>
          ...
          {useCases.map((uc, i) => (
            <li key={i} className="flex gap-5">
              ...
              <div>
                ...
                >
                  {uc.cta.label}
                  <svg aria-hidden="true" className="w-3.5 h-3.5 motion-safe:group-hover:translate-x-0.5 motion-safe:transition-transform" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
      ...
      <section aria-labelledby="witf-cta-heading" className="max-w-4xl text-center py-12 border-t border-gray-100">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <Link
            ...
            className="inline-flex items-center px-6 py-3 text-sm font-medium text-brand-600 bg-brand-50 rounded-xl hover:bg-brand-100 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:ring-offset-1"
          >
            Coffee Machines
          </Link>
          <Link
            href="/categories"
            className="inline-flex items-center px-6 py-3 text-sm font-medium text-gray-600 bg-gray-100 rounded-xl hover:bg-gray-200 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:ring-offset-1"
          >
            All Categories
          </Link>
        </div>
